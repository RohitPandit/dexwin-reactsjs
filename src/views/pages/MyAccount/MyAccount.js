...
import {
  ...
  Grid,
  Container,
  makeStyles, IconButton, Paper, Avatar
      ...
      <Box>
        ...
        <Paper className={classes.myAccountBox} mt={2} elevation={2}>
          <Box className="editBox">
            <Avatar className={classes.AvatarIcon} component={Link} to="/edit-profile"><BiPencil /></Avatar>
          </Box>
            ...
            >
              <Box className="accountImg" align="center">
                ...
                {/* <Box className="editprofile">
                  <FiEdit2 style={{fontSize:'16px',marginTop:'7px',marginLeft:'1px'}}/>
            </Box> */}
