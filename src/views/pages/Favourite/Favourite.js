    ...
    "& .mainContentBox": {
      ...
      "& .innerContent": {
        ...
        "& button": {
          "width": "83px",
          "height": "40px",
          "background": "radial-gradient(60.37% 50% at 50% 50%, rgba(255, 16, 16, 0.5) 0%, rgba(255, 0, 0, 0) 100%), linear-gradient(159.8deg, #FDB26D 24.32%, #FA6131 89.49%)",
    ...
    <Paper className={classes.favouriteBox} elevation={2}>
      ...
      <Paper className={classes.DashboardCardbox} mt={2}>
              ...
              <Grid container spacing={1}>
                <Grid item xs={7}>
                  <Box className="flexjustify">
                    ...
                    <Typography variant="body2" style={{ color: "#39AED0" }}>NBA League</Typography>
                  </Box>

                </Grid>
                <Grid item xs={5} align="center">
                  {type === "live" ? <>
                    <Typography variant="body2" style={{ display: "flex", alignItems: "center", justifyContent: "center" }} >Quarter 4-7</Typography >
                  </> : <>
                    <Typography variant="body2" style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>Today&nbsp;<FiClock style={{ fontSize: "11px" }} />&nbsp;18:44</Typography></>}
                </Grid>
              </Grid>
            </Grid>
            <Grid item xs={6}>
              <Grid container spacing={1}>
                <Grid item xs={4} align="center">
                  <Typography variant="body2" style={{ display: "flex", alignItems: "center", justifyContent: "center" }} >SPREAD</Typography>
                </Grid>
                <Grid item xs={4} align="center">
                  <Typography variant="body2" style={{ display: "flex", alignItems: "center", justifyContent: "center" }} >TOTAL</Typography>
                </Grid>
                <Grid item xs={4} align="right">
                  ...
                  <Box className="flexjustify" justifyContent="end">
                    <Typography variant="body2">
                      <FiClock style={{ fontSize: "11px" }} />&nbsp;&nbsp;GAME&nbsp;&nbsp;</Typography>&nbsp; &nbsp;
        ...
        <Box className="subheading">
          <Typography variant="body1"> <img src="images/Vectorsec.png" alt="Hello" /> &nbsp;&nbsp;&nbsp;Belarus Sky League</Typography>
        </Box>
              ...
              <Grid container spacing={1} alignItems="center" justifyContent="center">
                <Grid item xs={7}>
                  ...
                  <Box align="center" mt={1} mb={1}>
                    <Typography variant="h5" style={{ color: "#39AED0", marginLeft: "-55px" }}>VS</Typography></Box>
                  <Box className={classes.playerName}>
              ...
              <Grid container spacing={1} alignItems="center" justifyContent="center">
                ...
                <Grid item xs={4}>
                  <Box style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
                    <Button variant="outlined" color="primary">+300</Button>
                    <Button variant="outlined" color="secondary" style={{ marginTop: "10px", }}>-300</Button>
                  </Box>
                </Grid>
              </Grid>
            </Grid>
      ...
      <Box className={classes.spotbox}>
        ...
        >
          <Box>
            <Typography variant="h4" style={{ fontSize: "14px" }}>
              In Q4, how many points will Kobe Bryant have </Typography>
          </Box>
          <Box style={{ display: "flex" }}>
            <Typography
              className={classes.heading}
