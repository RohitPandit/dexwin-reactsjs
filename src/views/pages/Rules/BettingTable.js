  ...
  return (
    <TableContainer >
      <Table className={classes.table} aria-label="customized table">
        ...
        >
          <TableRow>
            <StyledTableCell style={{ borderRight: "1px solid rgb(255 255 255 / 15%)" }} >Type of Bet</StyledTableCell>
        ...
        <TableBody>
          {rows.map((row) => (
            <StyledTableRow key={row.name}>
              <StyledTableCell style={{ borderRight: "1px solid rgb(255 255 255 / 15%)" }} component="th" scope="row">
                {row.name}
              </StyledTableCell>
