  ...
  return (
    <TableContainer >
      <Table className={classes.table} aria-label="customized table">
        ...
        >
          <TableRow>
            <StyledTableCell style={{ borderRight: "1px solid rgba(255, 255, 255, 0.4)" }} >Type of Bet</StyledTableCell>
        ...
        <TableBody>
          {rows.map((row) => (
            <StyledTableRow key={row.name}>
              <StyledTableCell style={{ borderRight: "1px solid rgba(255, 255, 255, 0.4)" }} component="th" scope="row">
                {row.name}
              </StyledTableCell>
              <StyledTableCell style={{ maxWidth: "300px" }}>{row.calories}</StyledTableCell>
            </StyledTableRow>
          ))}
        </TableBody>
      </Table>
