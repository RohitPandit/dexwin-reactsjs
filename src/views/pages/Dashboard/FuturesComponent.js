...
import { makeStyles, Typography, Box, Button, Grid, Avatar, Divider, Paper } from "@material-ui/core";
    ...
    <div >
      <Paper className={classes.DashboardCardbox} elevation={2}>
        <Box className="headingBox">
          <Typography variant="h6"><img src="images/image 3.png" alt="Hello" />&nbsp;&nbsp; 2022-23 NBA Championship Winner</Typography>
          <Box className="flexjustify">
            <Typography variant="body2" ><FiClock style={{ fontSize: "11px" }} />&nbsp;&nbsp;MAY 30, 2023, 9: 00PM ET&nbsp;&nbsp;</Typography>
            &nbsp;&nbsp;<img src="/images/startimg.png" alt="Image" />
          </Box>
        </Box>
        <Box className="subheading">
          <Typography variant="body1"> <img src="images/Vectorsec.png" alt="Hello" />
            &nbsp;&nbsp;&nbsp;NBA Championship 2023 - Outright Betting</Typography>
        </Box>
              ...
              <Grid item xs={12} lg={6} md={12} sm={12} align="left">
                ...
                <Box >
                  <Grid container spacing={2} alignItems="center" justifyContent="center" >
                    ...
                    <Grid item xs={4} >
                      <Box >
                        <Button variant="outlined" color="secondary" >+300</Button>
                      </Box>
                    </Grid>
                  </Grid>
                </Box>
              ...
              <Grid item xs={12} lg={6} md={12} sm={12} >
                  ...
                  <Grid container spacing={2} alignItems="center" justifyContent="center" >
                    <Grid item xs={8} >
                      <Box className={classes.innerContentBox}>
                        <Avatar alt="Remy Sharp" src="images/team1.png" />
                        &nbsp;&nbsp;&nbsp;
                        <Typography variant="h6">Los Angeles Clippers</Typography>
                      </Box>
                    </Grid>
                    <Grid item xs={4} >
                      <Box >
                        <Button variant="outlined" color="primary">+750</Button>
                      </Box>
                    </Grid>
                  </Grid>
                </Box>
                <Box  >
                  <Grid container spacing={2} alignItems="center" justifyContent="center" >
                    ...
                    <Grid item xs={4} >
                      <Box >
                        <Button variant="outlined" color="secondary" >+750</Button>
                      </Box>
                    </Grid>
                  </Grid>
                </Box>
