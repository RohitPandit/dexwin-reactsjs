...
// const textDetails = [
//     {
//         text: "Money Line (Team that Wins)",
//         innerData: [
//             {
//                 text: "5-10",
//                 buttonNumber: "+300"
...
//                     <Grid container spacing={2} >
//                         {
//                             textDetails && textDetails?.map((componentsDetails, index) => {
//                                 return (
//                                     <Grid item xs={12}>
//                                         <CosafaAccordion componentsDetails={componentsDetails} type="allBets" />
//                                     </Grid>
//                                 )
//                             })
//                         }
...
// }
import React from 'react';
import { makeStyles, Box, Typography, Grid, Avatar, Paper, Button, withStyles } from '@material-ui/core';
                    ...
                    <Grid container spacing={2} >
                        {
                            textDetails && textDetails?.map((componentsDetails, index) => {
                                return (
                                    <Grid item xs={12}>
                                        <AllBetsCardComponent componentsDetails={componentsDetails} key={index} />
                                    </Grid>
                                )
                            })
                        }
            ...
            >
                ...
                <AccordionDetails style={{ display: "flex", flexDirection: "column" }}>
                    <Box mt={1}>
                        <Grid container spacing={2}>
                            {
                                componentsDetails?.answer && componentsDetails?.answer?.map((data, index) => {
                                    return (
