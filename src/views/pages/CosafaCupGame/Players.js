...
function Players() {
    ...
    const playerData = [
        {
            text: "Bet 1",
            desription: "Will Drake attend the Raptors vs Warriors game on Sunday and will Curry score 20+ points",
            number: "+300"
        },
        {
            text: "Bet 2",
            desription: "Will Lebron James wear the Lebron 18 for Christmas Game and score 30+ points",
            number: "+300"
        },
    ]
    return (
            ...
            <Box>
                ...
                <Box className="mainBox">
                    <Grid container spacing={2} >
                        ...
                        {
                            playerData && playerData?.map((data, index) => {
                                return (
                                    <Grid item xs={12}>
