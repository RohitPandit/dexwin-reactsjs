...
import { makeStyles, Box, Paper, Button, Grid, Avatar, Dialog, DialogContent, DialogTitle, TextField, IconButton, InputAdornment, } from "@material-ui/core";
...
const useStyles = makeStyles((theme) => ({
    ...
    btn: {
        backgroundColor: '#2B2B2B !important',borderRadius: '30px !important'
    ...
    btnNBA:{
        backgroundColor: '#2B2B2B !important',
        borderRadius: '100px !important', width: '8rem !important', padding: '15px', border:'1px solid #70D5FB'
    },
    select: {
        width: '10%',
        left: '0', marginRight: '40%', marginTop: '5%',
        backgroundColor: 'grey', padding: '2rem',
    },
    ...
    //     boxShadow: theme.palette.SearchIcon.boxShadow,
    //     transition: "all .25s ease",
    //     textShadow: theme.palette.SearchIcon.textShadow,
    //     borderRadius: "25px"
    // }
}));
...
export default function (props) {
    ...
    return (
        <>
          ...
          <Grid item xs={10} style={{ marginLeft: '-50%' }} className="teamCarousel">
            <Carousel responsive={responsive} style={{display:'flex'}} >
              ...
              <Button className={classes.btneuro} ><img src="images/EURO.png" style={{width:'1rem', height:'1rem'}}></img>EURO LEAGUE</Button>
              <Button className={classes.btn} ><img src="images/CBA.png" style={{width:'1rem', height:'1rem'}}></img>&nbsp;CBA</Button>
              <Button className={classes.btn} ><img src="images/NBA.png" style={{width:'1rem', height:'1rem'}}></img>&nbsp;FIBA</Button>
              <Button className={classes.btn} ><img src="images/CBA.png" style={{width:'1rem', height:'1rem'}}></img>&nbsp;NBA</Button>
              <Button className={classes.btn} ><img src="images/CBA.png" style={{width:'1rem', height:'1rem'}}></img>&nbsp;CBA</Button>
              <Button className={classes.btn} ><img src="images/NBA.png" style={{width:'1rem', height:'1rem'}}></img>&nbsp;NBA</Button>
                ...
                <Box className="butnsec">
                    ...
                    <Avatar className={classes.SearchIcon}>
                        <BsSearch style={{ cursor: "pointer" }} onClick={() => setDialogOpen(true)} />
                    </Avatar>
            ...
            <Box className="tabContainer">
                <Box className={classes.maincontent}>
                    {tabview === "POPULAR" ? <Popular matchId={matchId} /> : ""}
                    {tabview === "PROPS" ? <PropsIndex matchId={matchId} /> : ""}
                    {tabview === "SPOT" ? <Spot matchId={matchId} /> : ""}
                    {tabview === "exotic" ? <ExoticComponent matchId={matchId} /> : ""}
                    {tabview === "periodic" ? <Periodic matchId={matchId} /> : ""}
                    {tabview === "players" ? <Players matchId={matchId} /> : ""}
                    {tabview === "allBets" ? <AllBets matchId={matchId} /> : ""}
                </Box>
            </Box>
