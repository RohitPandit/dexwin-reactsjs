    ...
    "& .headingBox": {
      ...
      "& .logoBox": {
        ...
        "& figure": {
          ...
          height: "50px",
          position: "relative",
          boxShadow: "inset 0.2rem 0.2rem 0.5rem #050606, inset -0.2rem -0.2rem 0.5rem #4f4b4b",
          borderRadius: "50%",
          padding: "10px",
          // [theme.breakpoints.down("xs")]: {
          //   width: "30px",
        ...
        type === "betBuilderModal" ?
          <Box className="headingBox">
            <Box className="logoBox">
              ...
              <Typography variant="h6">BET BUILDER <span>
                (Create a Bet)
              </span></Typography>
            </Box>
          </Box> : " "
      ...
      <Box className='mainContent'>
        {type !== "betBuilderModal" ?
          <Box className='headingContent'>
            <Avatar id="closebutton"
              onClick={() => history.push("/")}
              className="closebtn" style={{ cursor: "pointer" }}>
              <ChevronLeftIcon />
            </Avatar>
            <Box>
        ...
        <Box mt={3}>
                ...
                <FormControl className={classes.formControl2}>
                  <Box className="selectmodalBox" onClick={handleClickOpen}>
                    <Grid container spacing={2} alignItems="center">
                      <Grid item xs="6">
                        <Box className={classes.selectbox} display="flex" alignItems="center">
                      ...
                      <Grid item xs="6" align="right" className={classes.arrowGrid}>
                        <MdArrowDropDown style={{ fontSize: "20px", marginRight: "-7px", }} />
                      </Grid>
                    </Grid>
                  </Box>
                </FormControl>
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={6} md={4}>
              {/* <Box className="datepickerBox">  <KeyboardDatePicker
            disableToolbar
            variant="inline"
            margin="normal"
          ...
          <Grid container spacing={2} alignItems="center" mt={1}>
            ...
            <Grid item xs={6} md={2} align='center'>
              <Box className="flexjustify" mt={3}>
                <img src="images/add_playerbutton.png" alt="image" style={{ cursor: "pointer" }} />
                <Typography variant="body2" style={{ marginLeft: "7px" }}>Add Player</Typography>
              </Box>
            </Grid>
          </Grid>
          {/* <Grid container spacing={2}>
            ...
            <Grid item xs={6} md={2}>
              <Box mt={2}>
                <Button variant="contained" color="primary" size="large" fullWidth style={{
                  ...
                  , fontSize: "12px", boxShadow: "-10px -10px 20px rgb(255 255 255 / 11%), 10px 10px 20px rgb(0 0 0 / 25%)",
                }}>
                  ...
                  {detailscard.map((data, i) => {
                    return (
                      <Grid item lg={12} md={12} sm={12} xs={12}>
                        <Grid container>
                          <Grid item lg={12} md={12} sm={12} xs={12}>
                            <Box display="flex" alignItems="center" style={{ borderBottom: "1px solid #424242", padding: "10px 0" }}>
                              <img src={data.image} alt="image" />
                              <Typography variant="h6" style={{ fontSize: "14px", marginLeft: "7px" }}>
                                {data.discription}
                              </Typography>
                            </Box>
                          </Grid>
