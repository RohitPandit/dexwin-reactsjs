...
import { makeStyles, Typography, Box, Button, Grid, Avatar, Divider } from "@material-ui/core";
							...
							<Grid container spacing={1} alignItems="center" justifyContent="center">
								<Grid item xs={7}>
									...
									<Box align="center" mt={1} mb={1}>
										<Typography variant="h5" style={{ color: "#39AED0", marginLeft: "-193px" }}>VS</Typography></Box>
									<Box className={classes.playerName}>
