...
export default function (props) {
	...
	return (
		<Box className={classes.PostBox} align="right">
			<Box className="flex" justifyContent="end" style={{marginLeft: "-76px",}}>
			&nbsp;&nbsp;&nbsp;&nbsp;<Typography variant="body1" style={{color: "#7784DA"}}>Q1</Typography>&nbsp;&nbsp;&nbsp;
				<Typography variant="body1" style={{color: "#7784DA"}}>Q2</Typography>&nbsp;&nbsp;&nbsp;
				<Typography variant="body1" style={{color: "#7784DA"}}>Q3</Typography>&nbsp;&nbsp;&nbsp;
				<Typography variant="body1" style={{color: "#7784DA"}}>Q4</Typography>
			</Box>
