            ...
            <Accordion>
              ...
              >
                ...
                >
                  ...
                  >
                    <Typography
                      className={classes.heading} color="primary"
                    ...
                    <Typography
                      ...
                      style={{ paddingRight: "85px" }} color="primary"
                    >
                      No
                    </Typography>
                  </Box>
                  ...
                  <Grid item lg={6} md={6} sm={12} xs={12}>
                    <Box className={classes.AccordionBox}>
                      ...
                      <Box className="butnsec">
                        <Button variant="contained" style={{ marginRight: "90px" }} >+300</Button>
                        <Button
                          variant="contained"
