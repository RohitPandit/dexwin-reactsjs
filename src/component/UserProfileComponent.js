...
import { makeStyles, Divider, Box, Grid, Avatar, Typography, Button, Paper, IconButton } from '@material-ui/core';
                ...
                <Box style={{ padding: "15px" }}>
                    <Grid container spacing={2} alignItems="center" justifyContent='center'>
                        ...
                        <Grid item xs={9} align="left">
                            ...
                            <Typography className={classes.userSelectNone} variant="body1"
                                style={{ color: "#39AED0" }}>
                                Connected
                            </Typography>
                            <Box mt={1}>
                                <Typography className={classes.userSelectNone} variant="body2"
                                    style={{ color: "#39AED0" }}>
                                    Your Balanace
                                </Typography>
                            </Box>
                            <Grid container alignItems="center">
                                <Grid item xs={6} align="left">
                                    <Box className="flexjustify">
                                        <img src="images/balance.png" alt="image" />
                                        <Typography className={classes.userSelectNone} variant="h6"
                                            style={{
                                                fontSize: "15px",
                                                marginLeft: "3px",
                                            }}>
                    ...
                    <Grid container alignItems="center" spacing={2}>
                        <Grid item xs={6} align="left">
                            <Box className={classes.modalButtonBox}>
                                <Button variant="contained" color="primary" fullWidth onClick={() => history.push("/my-account")}
                                >
                                    View profile
                                </Button>
                            </Box>
                        ...
                        <Grid item xs={6} align="left">
                            <Box className={classes.modalButtonBox}>
                                <Button variant="contained" color="primary" fullWidth onClick={() => history.push("/wallet")}  >
                                    Wallet
                                </Button>
                            </Box>
                        </Grid>
                        <Grid item xs={6} align="left">
                            <Box className={classes.modalButtonBox}>
                                <Button variant="contained" color="primary" fullWidth onClick={() => history.push("/my-bets")} >
                                    My Bets
                                </Button>
                            </Box>
                        </Grid>
                        <Grid item xs={6} align="left">
                            <Box className={classes.modalButtonBox}>
                                <Button variant="contained" color="primary" fullWidth onClick={() => history.push("/transaction")} >
                                    Transaction
                                </Button>
                            </Box>
                        </Grid>
