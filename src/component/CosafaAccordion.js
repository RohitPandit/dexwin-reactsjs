...
import { makeStyles, Box, Typography, Grid, withStyles, Button, Divider } from '@material-ui/core';
...
function CosafaAccordion(props) {
    ...
    const { matchId, data, type, playersPropsData, spotCarddata, exoticCardData, periodicCardData, componentsDetails } = props;
    ...
    const _addBetSlip = async (odds, betType) => {
        if (auth.isLogin()) {
            const res = await addBetSlip(matchId, odds, betType, ...matchDetails);
            if (res) {
                            ...
                            <AccordionDetails style={{ display: "flex", flexDirection: "column" }}>
                                <Box style={{
                                    ...
                                    <Grid container spacing={3}>
                                        {
                                            periodicCardData?.answer && periodicCardData?.answer?.map((data, index) => {
                                                return (
                                                    ...
                                                    <Grid item xs={12} lg={12} md={12}>
                                                        <Box className={classes.secondDeaultwithRadius} >
                                                            <Grid container spacing={2} alignItems="center">
                                                                ...
                                                                <Grid item xs={6} md={6} >
                                                                    <Box className={classes.detailsBox} style={{ justifyContent: "end" }}>
                            ...
                            <AccordionDetails style={{ display: "flex", flexDirection: "column" }}>
                                <Box my={1}>
                                    <Grid container spacing={2}>
                                        {
                                            componentsDetails?.innerData && componentsDetails?.innerData?.map((data, index) => {
                                                return (
                                                    <Grid item xs={6} >
                                                    ...
                                                    <Grid item xs={12} lg={6} md={6}>
                                                        <Box className={classes.secondDeaultwithRadius} >
                                                            <Grid container spacing={2} alignItems="center">
                                                                ...
                                                                <Grid item xs={6} md={6} >
                                                                    <Box className={classes.detailsBox} style={{ justifyContent: "end" }}>
                                                                        <Button variant='outlined' color="primary" onClick={() => _addBetSlip(data?.homeOdd, data?.text)} className={classes.buttonStyle}>
                                                                            {data?.homeOdd}
                                                                        </Button>&nbsp;&nbsp;
                                                                        <Button variant='outlined' color="secondary" onClick={() => _addBetSlip(data?.awayOdd, data?.text)} className={classes.buttonStyle}>
                                                                            {data?.awayOdd}
                                                                        </Button>
                                                                    </Box>
                                                                </Grid>
                                                    ...
                                                    <Grid item xs={12} lg={6} md={6}>
                                                        <Box className={classes.secondDeaultwithRadius} >
                                                            <Grid container spacing={2} alignItems="center">
                                                                ...
                                                                <Grid item xs={6} md={6} >
                                                                    <Box className={classes.detailsBox} style={{ justifyContent: "end" }}>
                                                                        <Button variant='outlined' onClick={() => _addBetSlip(data?.homeOdd, data?.text)} color="primary" className={classes.buttonStyle}>
                                                                            {data?.homeOdd}
                                                                        </Button>&nbsp;&nbsp;
                                                                        <Button variant='outlined' color="secondary" onClick={() => _addBetSlip(data?.drawOdd, data?.text)}  className={classes.buttonStyle}>
                                                                            {data?.drawOdd}
                                                                        </Button>&nbsp;&nbsp;
                                                                        <Button variant='outlined' color="secondary" onClick={() => _addBetSlip(data?.awayOdd, data?.text)}  className={classes.buttonStyle}>
                                                                            {data?.awayOdd}
                                                    ...
                                                    <Grid item xs={12} lg={6} md={6}>
                                                        <Box className={classes.secondDeaultwithRadius} >
                                                            <Grid container spacing={2} alignItems="center">
                                                                ...
                                                                <Grid item xs={6} md={6} >
                                                                    <Box className={classes.detailsBox} style={{ justifyContent: "end" }}>
                                                                        <Button variant='outlined' onClick={() => _addBetSlip(data?.odd, data?.text)} color="primary" className={classes.buttonStyle}>
                                                                            {data?.odd}
                                                                        </Button>
                                                                    </Box>
                                                                </Grid>
                    ...
                    type === "exotic" && (
                        ...
                        >
                            ...
                            <AccordionDetails style={{ display: "flex", flexDirection: "column" }}>
                                <Box mt={2}>
                                    <Grid container spacing={2}>
                                        {exoticCardData.description && exoticCardData.description?.map((data, index) => {
                                            return (
                                                <Grid item xs={12}>
                                                    <Box className={classes.secondDeaultwithRadius}>
                                                        <Box className={classes.detailsBox} >
                        ...
                        >
                            ...
                            <AccordionDetails style={{ display: "flex", flexDirection: "column" }}>
                                <Box style={{
                                    ...
                                    <Grid container spacing={3}>
                                        {
                                            exoticCardData?.answer && exoticCardData?.answer?.map((data, index) => {
                                                return (
                                                    <Grid item xs={12} lg={6} md={6}>
                                                        <Box className={classes.secondDeaultwithRadius} >
                                                            <Grid container spacing={2} alignItems="center">
                                                                ...
                                                                <Grid item xs={6} md={6} >
                                                                    <Box className={classes.detailsBox} style={{ justifyContent: "end" }}>
                                                                        <Button variant='outlined' color="primary" className={classes.buttonStyle} onClick={() => _addBetSlip(data?.odd, exoticCardData?.question)}>
                                                                            {data?.odd}
                                                                        </Button>
                                                                    </Box>
                                                                </Grid>
                        ...
                        >
                            ...
                            <AccordionDetails style={{ display: "flex", flexDirection: "column" }}>
                                <Box mt={4} mb={4}>
                                    <Grid container spacing={2}>
                                        {
                                            spotCarddata.description && spotCarddata.description?.map((data, index) => {
                                                return (
                                                    <Grid item xs={12}>
                                                        <Box className={classes.secondDeault}>
                                                            <Box className={classes.detailsBox}>
                                                                {/* className={`${classes.detailsBox} secondDeault`} */}
                                                                <Typography variant='body2'>{data?.text}</Typography>
                                                                <Box style={{ display: "flex" }}>
                                                                    <Button variant='outlined' color="primary" className={classes.buttonStyle}>
                                                                        {data?.num1}
                                            ...
                                            <Grid item xs={5}>
                                                <Box className='d-flexspacebetween'>
                                                    ...
                                                    <Typography
                                                        variant="h6"
                                                        style={{
                                                            fontSize: "15px", marginRight: "20px",
                                                            color: "#787878"
                                                        }}
                                                    >
                                                        NO
