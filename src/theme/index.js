...
const themesOptions = [
  {
    ...
    overrides: {
      ...
      MuiAvatar: {
        colorDefault: {
          borderRadius: 25,
          background: "radial-gradient(64.29% 64.29% at 30% 25.71%, #fffbfb 0%, #d7d3d3 100%)",
          border: "2px solid #dfdfe1",
          transition: "all .25s ease",
          color: "#A2B1CA",
          fontSize: 12,
          textShadow: "0px 0px 2px rgba(0,0,0, 1)",
          boxShadow: "-1px -1px 15px 0px rgb(0 0 0 / 30%), -7px -7px 15px 0px rgb(255 255 255), inset 0px 0px 0px 0px rgb(0 0 0 / 0%), inset 0px 0px 0px 0px rgb(255 255 255 / 0%)",
        },
      },
      MuiPaper: {
        root: {
      ...
      MuiButton: {
        ...
        containedSecondary: {
          backgroundColor: "#F5F5F5",
          boxShadow: "0px -3px 10px rgb(255 255 255 / 5%), 10px 10px 20px rgb(0 0 0 / 58%)",
          borderRadius: "100px",
          height: "40px",
          color: "#4E525A",
          fontWeight: " 800",
    ...
    palette: {
      ...
      background: {
        ...
        topbarButtonShadow:"inset 10px 10px 20px #ceccda, inset -10px -10px 20px #ffffff",
        boxshadows: "-14px -14px 20px 0px #ffffff, 10px 10px 20px #d2d1db",
        perlyBox: "linear-gradient(128.77deg, rgba(233, 232, 239, 0) 24.06%, #8DE6D1 112.24%)",
      ...
      CircularSlider: {
        background: "#C4C1CE",
        boxShadow: "inset -10px -10px 20px rgb(255 255 255 / 25%), inset 10px 10px 20px rgb(0 0 0 / 51%)",
      },
      searchIcon: {
        background: "radial-gradient(64.29% 64.29% at 30% 25.71%, #6D6D6D 0%, #f3eeee 100%)",
        boxShadow: "7px 7px 15px 0px rgb(0 0 0 / 30%), -1px -2px 5px 0px rgb(242 242 242), inset -1px -1px 1px 0px rgb(0 0 0 / 30%), inset 1px 1px 2px 0px rgb(162 154 154)",
  ...
  },
  {
    ...
    overrides: {
      ...
      MuiButton: {
        ...
        containedPrimary: {
          ...
          "&:hover": {
            boxShadow: "8px 8px 20px rgb(0 0 0 / 50%), -3px -3px 20px rgb(255 255 255 / 20%), inset 4px 6px 20px rgb(0 0 0), inset -11px -4px 20px rgb(255 255 255 / 20%)",
          }
        },
        containedSecondary: {
          ...
          borderRadius: "40px",
          color: "#ffffff",
          background: "linear-gradient(0deg, #222222, #222222), linear-gradient(118.84deg, #70D5FB 24.55%, #4B4E83 97.71%)",
          boxShadow: "0px -3px 10px rgb(255 255 255 / 14%), 10px 10px 20px rgb(0 0 0 / 45%)",
          "&:hover": {
      ...
      MuiInput: {
        root: {
          borderRadius: "50px",
          boxShadow: "0.3rem 0.3rem 0.6rem #0f1111, -0.22rem -0.12rem 0.5rem 2px #333131",
          "&.Mui-focused": {
    ...
    palette: {
      ...
      CircularSlider: {
        background: "linear-gradient(144.35deg, #3F3F3F 12.66%, #1B1B1B 88.77%)",
      },
      searchIcon: {
        background: "radial-gradient(64.29% 64.29% at 30% 25.71%, #6D6D6D 0%, #141414 100%)",
        boxShadow: "7px 7px 15px 0px rgb(0 0 0 / 30%), -1px -2px 5px 0px rgb(112 102 102), inset -1px -1px 1px 0px rgb(0 0 0 / 30%), inset 1px 1px 2px 0px rgb(162 154 154)",
      ...
      background: {
        ...
        selectBox: "#2B2C31",
        searchBox: "#3D3D3D",
        topbarButtonShadow:"inset -10px -10px 20px rgb(255 255 255 / 10%), inset 10px 10px 20px rgb(0 0 0 / 66%)",
        boxshadows: "-5px -5px 20px rgb(191 191 191 / 10%), 10px 10px 20px rgb(0 0 0 / 34%)",
        perlyBox: "linear-gradient(123.65deg, rgba(75, 78, 131, 0.87) 2.89%, rgba(126, 222, 216, 0.22) 110.48%)",
        default: "#222222",
        secondDeault: "#343333",
        heading: "#1A1A1A",
